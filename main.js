function starClasification ()
{
    ...
    classifier = ml5.soundClassifier("https://storage.googleapis.com/tm-model/Vj4b1YQ-g/model.json", modelReady);
}
...
function gotResults(error, results){
    if (error) {
        ...
        if (results[0].label == "Alarma") {
          ...
          img2.src = 'aliens-03.png';
          img3.src = 'aliens-04.png';
        } else if (results[0].label == "Chisquidos") {
          img.src = 'aliens-01.png';
          img1.src = 'aliens-02.png';
          img2.src = 'aliens-03.gif';
          img3.src = 'aliens-04.png';
        } else if (results[0].label == "Tocar") {
            img.src = 'aliens-01.png';
            img1.src = 'aliens-02.png';
            img2.src = 'aliens-03.gif';
            img3.src = 'aliens-04.png';  
